    ...
    <div className="min-h-[calc(100vh-64px)] grid grid-cols-1 md:grid-cols-2">
      ...
      <div className="flex justify-center items-center py-10 px-4">
        <div className="w-full max-w-md bg-white rounded-xl shadow-md p-8">
          <h1 className="text-3xl font-bold text-center text-[#5253A3] mb-2">Create an Account</h1>
          <p className="text-gray-600 text-center mb-8">Join Story Yetu and start creating magical stories for children</p>

          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label htmlFor="name" className="block text-[#5253A3] font-medium mb-2">Full Name</label>
              <input
                type="text"
                id="name"
                name="name"
            ...
            <div className="mb-6">
              <label htmlFor="confirmPassword" className="block text-[#5253A3] font-medium mb-2">Confirm Password</label>
              <div className="relative">
                <input
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#34A853] text-white rounded-md hover:cursor-pointer py-3 text-lg font-semibold flex justify-center items-center"
            >
              {isLoading ? (
                <>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              Already have an account? <Link to="/sign-in" className="text-[#5253A3] font-medium hover:underline">Sign in</Link>
            </p>
          </div>
